                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        {[
                            ...
                            <a key={social.name} href="#" className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:text-white hover:bg-orange-500 hover:border-orange-500 transition-all shadow-sm">
                ...
                <div className="relative w-full max-w-4xl mx-auto mb-10">
                    ...
                    <div className="bg-white/80 backdrop-blur-md border border-slate-100 shadow-xl shadow-slate-200/50 rounded-full p-3 md:p-4 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3 w-full justify-center md:justify-end">
                            <a href="tel:18005554321" className="flex items-center gap-3 px-6 py-3 bg-slate-50 rounded-full text-slate-700 font-bold text-sm hover:bg-orange-50 hover:text-orange-600 transition-colors group w-full sm:w-auto justify-center border border-slate-100">
                                <svg className="w-4 h-4 text-slate-400 group-hover:text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                1-800-555-4321
                            </a>

                            <a href="mailto:hello@brndx.com" className="flex items-center gap-3 px-6 py-3 bg-slate-50 rounded-full text-slate-700 font-bold text-sm hover:bg-blue-50 hover:text-blue-600 transition-colors group w-full sm:w-auto justify-center border border-slate-100">
